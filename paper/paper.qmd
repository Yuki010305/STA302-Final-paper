...
hist(zillowtrim$bathroomcnt, breaks=10,main="", xlab="bathroom")
...
b=ggplot(data=zillowtrim, aes(x=bedroomcnt, y=price)) + 
  geom_point() + 
  geom_smooth(method = lm, se = FALSE,size=1.5) + 
  labs(x = 'bedroom', y='Sale Price')+
  theme_bw()
